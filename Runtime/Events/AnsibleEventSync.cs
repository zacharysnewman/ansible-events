...
namespace AnsibleEvents.Events
{
    ...
    public class AnsibleEventSync<T>
    {
    ...
    public class AnsibleEventSync<T, U>
    {
    ...
    public class AnsibleEventSync<T, U, V>
    {
    ...
    public class AnsibleEventSync<T, U, V, W>
    {
